...
def main():
    ...
    ### パスタブ
    IDirLabel1.grid(row=0,column=0,padx=10)
    IDirEntry1.grid(row=0,column=1,padx=10)
    IDirButton1.grid(row=0,column=2,padx=10)

    IDirLabel2.grid(row=1,column=0,padx=10)
    IDirEntry2.grid(row=1,column=1,padx=10)
    IDirButton2.grid(row=1,column=2,padx=10)

    IDirLabel3.grid(row=2,column=0,padx=10)
    IDirEntry3.grid(row=2,column=1,padx=10)
    IDirButton3.grid(row=2,column=2,padx=10)
    ...
    ### パック 
    mesh_tab_IDirLabel1.grid(row=0,column=0,padx=10)
    mesh_tab_IDirButton3.grid(row=0,column=1,padx=10)
    ...
    ### パック
    calc_tab_IFileLabel1.grid(row=0,column=0,padx=10)
    calc_tab_IFileEntry1.grid(row=0,column=1,padx=10)
    calc_tab_IFileButton1.grid(row=0,column=2,padx=10)

    calc_tab_IFileLabel2.grid(row=2,column=0,padx=10)
    calc_tab_IFileEntry2.grid(row=2,column=1,padx=10)
    calc_tab_IFileButton2.grid(row=2,column=2,padx=10)

    calc_tab_IFileLabel3.grid(row=4,column=0,padx=10)
    calc_tab_IFileButton3.grid(row=4,column=2,padx=10)
    ...
    ### 配置
    post_tab_IDirLabel2.grid(row=0,column=0,padx=10)
    post_tab_IDirButton2.grid(row=0,column=1,padx=10)
